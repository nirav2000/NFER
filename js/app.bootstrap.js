...
import { getLastDiagnostic, loadHistory, saveCurrentTest, getHistory } from './storage.js?v=3.4.7';
import { renderDashboardMeta, renderDiagnostic, renderTracker, renderAttemptReview, renderFeedbackAssist } from './renderer.js?v=3.4.7';
import { createFeedbackPrompt, openPromptInChatGPT, copyPrompt } from './feedback.js?v=3.4.7';
import { installRuntimeDiagnostics } from './runtimeDiagnostics.js?v=3.4.7';
import { initGlobalUI, currentPage } from './app.global-ui.js?v=3.4.7';
import { initDashboardPage } from './appDashboard.js?v=3.4.7';
import { bindFeedbackAssist, initDiagnosticPage, initTrackerPage, initAttemptPage } from './appReports.js?v=3.4.7';
import { initTestRuntime } from './app.test-runtime.js?v=3.4.7';
import { createOpenAIFeedbackModule } from './feedbackOpenAI.js?v=3.4.7';
